...
var safeConsoleMethod = function (original) {
    return function () {
        var args = [];
        ...
        try {
            ...
            if (error.code !== 'EPIPE' && error.message !== 'write EPIPE') {
                ...
                try {
                    process.stderr.write("Console error: ".concat(error.message, "\n"));
                }
                catch (_a) {
...
if (typeof globalThis.File === 'undefined') {
    // @ts-ignore
    globalThis.File = /** @class */ (function () {
        function File(chunks, name, options) {
            this.name = name;
        ...
        File.prototype.arrayBuffer = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this._buffer.buffer.slice(this._buffer.byteOffset, this._buffer.byteOffset + this._buffer.byteLength)];
                });
            });
        };
        File.prototype.text = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this._buffer.toString('utf-8')];
                });
            });
        };
...
if (typeof globalThis.Blob === 'undefined') {
    // @ts-ignore
    globalThis.Blob = /** @class */ (function () {
