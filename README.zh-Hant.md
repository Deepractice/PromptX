<div align="center">
  ...
  <h1>PromptX · 領先的AI Agent上下文平台</h1>
...
| 平台                           | 下載連結                                                                                     |
| ------------------------------ | -------------------------------------------------------------------------------------------- |
| 🍎**macOS (Apple 晶片)** | [下載 .dmg](https://promptx.deepractice.ai/download/latest/promptx-desktop-mac-arm64.dmg)       |
| 🍎**macOS (Intel 晶片)** | [下載 .dmg](https://promptx.deepractice.ai/download/latest/promptx-desktop-mac-x64.dmg)         |
| 🪟**Windows**            | [下載 .exe](https://promptx.deepractice.ai/download/latest/promptx-desktop-win32-x64-setup.exe) |

[📦 查看所有版本和平台](https://promptx.deepractice.ai/download/) (Linux、可攜版等)
...
PromptX Desktop 客戶端不只是 MCP 伺服器啟動器，它內建了一個完整的下一代 Agent 平台。
...
PromptX 內建 8 個精心打造的角色，每個都是各自領域的專家。一句話即可啟用任意角色。

### 🏛️ V1 角色（DPML）— 久經考驗的專家

| 頭像                                                               | ID            | 名稱                            | 專長                               |
| ------------------------------------------------------------------ | ------------- | ------------------------------- | ---------------------------------- |
| ![nuwa](packages/resource/resources/role/nuwa/profile.png)           | `nuwa`      | **女媧 · Nuwa**          | AI角色創造 — 一句話，一個專家     |
| ![luban](packages/resource/resources/role/luban/profile.png)         | `luban`     | **魯班 · Luban**         | 工具整合大師 — 任何API，3分鐘搞定 |
| ![sean](packages/resource/resources/role/sean/profile.png)           | `sean`      | **姜山 · Sean**          | 產品決策與創業策略                 |
| ![writer](packages/resource/resources/role/writer/profile.png)       | `writer`    | **文章寫手 · Writer**    | 不像AI的專業內容創作               |
| ![jiangziya](packages/resource/resources/role/jiangziya/profile.png) | `jiangziya` | **姜子牙 · Jiangziya**   | AI時代行業轉型與角色設計顧問       |
| ![shaqing](packages/resource/resources/role/shaqing/profile.png)     | `shaqing`   | **傻青 · Shaqing**       | 哲學嚮導 — 幫你認識自己           |
| ![teacheryo](packages/resource/resources/role/teacheryo/profile.png) | `teacheryo` | **YoYo老師 · TeacherYo** | AI時代教育轉型顧問                 |
| ![dayu](packages/resource/resources/role/dayu/profile.png)           | `dayu`      | **大禹 · Dayu**          | V1→V2角色遷移與組織管理           |

### 🎭 **女媧 - AI角色設計師**

<div align="center">
  <img src="packages/resource/resources/role/nuwa/profile.png" alt="女媧" width="100" style="border-radius: 50%; margin: 15px 0 25px 0;">
</div>
...
<div align="center">
  <img src="packages/resource/resources/role/luban/profile.png" alt="魯班" width="100" style="border-radius: 50%; margin: 15px 0 25px 0;">
</div>
...
PromptX 內建專業文件處理工具，讓 AI 成為你的辦公助手。
